<?php
  if (isset($this->session->userdata['client'])) {
    $pseudo = ($this->session->userdata['client']['nom']);
    $email = ($this->session->userdata['client']['prenom']);
			...
			<div>
				...
				<div class="col-md-offset-5 col-md-5">
					<ul id="navigation">
						...
						<li>
							<a href="<?php echo base_url(); ?>client/inscription">Inscription</a>
						</li>
						<li>
							<a href="<?php echo base_url(); ?>client/connexion">Connexion</a>
						</li>
					</ul>
				</div>
			</div>
